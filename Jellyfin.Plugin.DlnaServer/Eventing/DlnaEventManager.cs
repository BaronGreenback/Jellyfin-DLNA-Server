...
namespace Jellyfin.Plugin.DlnaServer.Eventing
{
    ...
    public class DlnaEventManager : IDlnaEventManager
    {
        ...
        public EventSubscriptionResponse RenewEventSubscription(string subscriptionId, string notificationType, string requestedTimeoutString, string callbackUrl)
        {
            ...
            if (subscription == null)
            {
                return new EventSubscriptionResponse
                {
                    ...
                    Headers = { { "NT", notificationType }, { "LOCATION", callbackUrl } }
                };
            }
            ...
            _logger.LogDebug(
                "Renewing event subscription for {NotificationType} with timeout of {Timeout} to {Callback}",
        ...
        {
            _logger.LogDebug("Cancelling event subscription {Id}", subscriptionId);
